...
class FileUnblockerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Deep File Unblocker & Permission Fixer - ver 1.1")
    ...
    def open_log_file(self):
        """Opens the generated log file in the default text editor."""
    ...
    def log_msg(self, message, level="INFO"):
        """Logs to file and safely queues UI update."""
        if level == "ERROR":
        ...
        try:
            ...
            if not self.dry_run_active:
                try:
                    ...
                    pass # File wasn't blocked, which is fine
